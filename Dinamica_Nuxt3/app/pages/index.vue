  ...
  <div>
    <section class="section_slide">
      <div class="section_slide_content">
        ...
        <p class="section_slide_content_description"
          >Descubre poderosas criaturas.</p
        >
        <button
          type="button"
          class="section_slide_content_button"
          title="boton de descarga"
      ...
      <figure class="section_slide_image" title="ilustracion de un tama">
        <img
          class="section_slide_image_gamer"
          alt="criatura Tama"
          title="ilustracion de un tama con equipamiento de ataque y defensa"
          src="~/assets/images/pages/cf-5.webp"
        />
      </figure>
    </section>
    ...
    <section class="section_category-popular">
      <div class="section_category-popular_title">
        <img
          class="section_category-popular_title_img"
          alt="separador de seccion"
          title="Corona separadora se seccion"
          src="~/assets/images/icons-buttoms/title-purchase.webp"
        />
        <h2 class="section_category-popular_title_name"
          >Bienvenido a un nuevo universo.</h2
        >
      </div>
      <div class="section_category-popular_content">
        <div class="section_category-popular_content-card">
          <img
            class="section_category-popular_content-card_img"
            alt="imagen Gameplay Tama"
            title="ilustracion de tama jugando"
            src="~/assets/images/pages/cf-1.webp"
          />
          ...
          <NuxtLink
            to="/items/gameplay"
            aria-label="link ir al lore"
            title="ir al Lore o historia Tama Kingdom"
            class="section_category-popular_content-card_link"
          >
            <i
              class="las la-angle-right la-3x section_category-popular_content-card_link_icon"
            ></i>
          </NuxtLink>
        </div>
        <div class="section_category-popular_content-card">
        ...
        <div class="section_category-popular_content-card">
          <img
            class="section_category-popular_content-card_img"
            alt="imagen Economia Tama"
            title="ilustracion de  la economia de tamakingdom"
            src="~/assets/images/pages/anillo2.webp"
          />
    ...
    <section class="section_news">
      <div class="section_news_title">
        ...
        <p class="section_news_title_description"
          >Mantente actualizado con nuestras novedades más recientes.</p
        >
      </div>
      <PageNewsHome />
    </section>
